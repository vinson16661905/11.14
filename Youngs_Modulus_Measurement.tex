...
\subsection{逐差法数据处理}
注意到 $i=0$ 的数据线性不佳，可能是因为金属丝有弯折因而在最初加砝码时被拉直，伸长量偏大，故舍去，从 $i=1$ 的数据开始处理。
...
考虑其B类不确定度，两项相减，不确定度乘$\sqrt{2}$,之后4个差值取平均，不确定度除以$\sqrt{4}$

\[
\sigma_B = \frac{\sqrt{2}}{2} \sigma_{CCD} = \SI{0.0204124}{mm}.
\]

\[
\sigma_{\text{avrg}}=\SI{0.00493447}{mm},\qquad 
\sigma_{\delta L}=\sqrt{\left(\frac{\sigma_{\text{CCD}}}{5}\right)^2+\sigma_{\text{avrg}}^2}=\SI{0.00640435}{mm}.
\]

\[
\delta L \pm \sigma_{\delta L} = \SI{0.138 \pm 0.006}{mm}.
\]
...
=0.0685208\times 10^{11}\ \mathrm{Pa}.
\]

\[
E \pm \sigma_E = (1.37 \pm 0.07)\times 10^{11}\ \mathrm{Pa}.
\]
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{OpticalLever.png}
\caption{光杠杆法图像}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{MetalBeam.png}
\caption{金属梁法图像}
\end{figure}
